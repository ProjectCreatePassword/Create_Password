...
def ispasswordtrue():
	...
	if checkpassword():
		...
		erreur.grid(column=1, row=1)
		erreur.configure(text=message_erreur)
...
#-------------------------------------------------------
#---------Message d'erreur
erreur = Label(window, font=("Courrier", 10), bg="#181A1B", fg="red", justify="left", anchor="w")
